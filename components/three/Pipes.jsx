...
import { fetchData } from '@/components/three/utils/loader'

const accents = ['#07A267', '#8CAD02', '#ffcc00']
...
export function Pipes(props) {
  ...
  return (
    <Canvas onClick={handleClick} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 15], fov: 17.5, near: 1, far: 20 }} {...props} className='rounded-[3rem]'>
      <color attach="background" args={['#8CAD02']} />
